...
export const TRACKS: Track[] = [
  { uri: "demo:0", artist: "Khruangbin",       title: "Maria También",         album: "Con Todo El Mundo",            time: "3:48", len: 228, hue: 18  },
  { uri: "demo:1", artist: "Boards of Canada", title: "Roygbiv",               album: "Music Has the Right to Children", time: "2:31", len: 151, hue: 200 },
  { uri: "demo:2", artist: "Aphex Twin",       title: "Avril 14th",            album: "Drukqs",                       time: "2:05", len: 125, hue: 150 },
  { uri: "demo:3", artist: "Tame Impala",      title: "Let It Happen",         album: "Currents",                     time: "7:47", len: 467, hue: 280 },
  { uri: "demo:4", artist: "Burial",           title: "Archangel",             album: "Untrue",                       time: "3:53", len: 233, hue: 240 },
  { uri: "demo:5", artist: "Sade",             title: "Cherish the Day",       album: "Love Deluxe",                  time: "5:31", len: 331, hue: 32  },
  { uri: "demo:6", artist: "Charli XCX",       title: "Von dutch",             album: "BRAT",                         time: "2:42", len: 162, hue: 80  },
  { uri: "demo:7", artist: "Massive Attack",   title: "Teardrop",              album: "Mezzanine",                    time: "5:31", len: 331, hue: 350 },
];
...
export function Icon({ name, size = 24, stroke = "currentColor", sw = 2 }: IconProps) {
  const p = {
    width: size,
    height: size,
    viewBox: "0 0 24 24",
...
// Returns an integer ticker for ambient animations.
export function useTicker(intervalMs = 80): number {
...
// Deterministic-ish noise: stable looping VU value [0..1].
export function vu(t: number, seed = 0): number {
